...
inline bool operator==(MEM_BINDING a, MEM_BINDING b) NOEXCEPT {
    return a.mem_state->mem == b.mem_state->mem && a.offset == b.offset && a.size == b.size;
}
...
struct hash<MEM_BINDING> {
    size_t operator()(MEM_BINDING mb) const NOEXCEPT {
        auto intermediate = hash<uint64_t>()(reinterpret_cast<uint64_t &>(mb.mem_state->mem)) ^ hash<uint64_t>()(mb.offset);
